...
$
    L(\theta, \theta_1, \theta_2) = L(\theta, \theta_1) + L(\theta, \theta_2) = - \sum_{i=1}^M logp(m=m_i|\theta, \theta_1) - \sum_{j=1}^N logp(n=n_i|\theta, \theta_2) , m_i \in [1, 2, ..., |V|]; n_i \in [IsNext, NotNext]
$
